...
def sqlconverter(data):
     ...
     if data.startswith("Municipio"):
         numMunicipio += 1
         data = f"INSERT INTO Municipios (idMunicipio,estados_idEstado, nombreMunicipio) VALUES ({numMunicipio}, {numEstado} , '{data}');"

     elif data.startswith("Parroquia"):
            numParroquia += 1
            data = f"INSERT INTO Parroquias (idParroquia, municipios_idMunicipio, nombreParroquia) VALUES ({numParroquia}, {numMunicipio} , '{data}');"

     elif data.startswith("Ciudad"):
            numCiudad += 1
            data = f"INSERT INTO Ciudades (idCiudad, parroquias_idParroquia, nombreCiudad) VALUES ({numCiudad}, {numParroquia} , '{data}');"
...
print("INSERT INTO Pais (idPais,nombrePais, estatus) VALUES (1, 'Venezuela', 'Activo')")
print("INSERT INTO Estados (idEstado,nombreEstado,paises_idPais) VALUES (1,'Nueva Esparta',1);")
print(*resultado, sep = "\n")
